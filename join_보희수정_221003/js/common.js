...
function check() {
  ...
  // if (frm.pw.value != frm.re_password.value) {
  //   //같지않을때 비교연산자써주기!
  ...
  console.log(email_get01)
  console.log(email_get02)
  ...
  // document.getElementsByName("frm").onsubmit = function () {
  //   const email_get01 = frm.email1.value;
  //   const email_get02 = frm.email2.value;
  //   console.log(email_get01)
  //   console.log(email_get02)
